...
Note that the equations (\ref{fulldeltapsi}) are obtained from the continuum equations presented in Chapter \ref{Chap:Theory}. In the continuum theory we had a solid sphere with an average velocity ${\bf V}$. In the present case (i.e. fixed walls) this velocity must be equal to zero.  
...
the present chapter.  equation   (\ref{GKCorrected}) is conceptually pleasing
