...
vector           $\hat{{\bf g}}(z)=\{\hat{{\bf g}}^x_1(z),\cdots,\hat{{\bf g}}^x_{N_{\rm
...
effect on  the fluid  near the wall.   From Fig.  \ref{Fig.17nodes} we
...
real  space.    We  plot  in  Fig.    \ref{Fig.Auto17}  some  selected
...
for the  cross-correlations, as shown in  Fig. \ref{Fig.Cross17}. Note
