...
%  One of
% the objectives of  the present work has been the  determination of the
% relaxation  matrix   $\Lambda^*$  that   governs  the  decay   of  the
% correlation,  and also  the  time $\tau$  beyond  which the  Markovian
% approximation is expected to be valid. Hydrodynamics is local
