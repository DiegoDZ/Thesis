...
\begin{figure}
\centering
\includegraphics[scale=0.5]{Ct-matrix-PBC}
...
\begin{figure}{Ct-mu30nu-PBC}
  \caption[Pendiente]{The diagonal $\tilde{C}_{\mu\mu}(t)$ of the Fourier transform
  of the correlation  matrix $C(t)$ for different values  of the time.
  In      descending     order      the     plotted      times     are
  $t=0.10,0.12,0.14,0.16,0.18,0.20$.  The  evolution of  the different
...
matrix in that  region.  In Fig.  \ref{Fig-CtExp.eps}  middle panel we
