...
In this section, we use Mori theory in the notation presented in Section \ref{Sec:Mori} for prediction the dynamics of equilibrium correlations of transverse momentum density in a periodic box in the time domain. 
...
In the following section  we will show the different quatities we have expressed in the previous part of this chapter. 
The correlation matrix of the discrete momentum $C(t)$ and the correlation of the discrete
stress  that appears  in  the Green-Kubo  running integral  $\eta(t)$ can be measured from MD. 
In  order to
...
\begin{figure}
    \centering
    \includegraphics[scale=0.8]{Ct-17nodes-matrix}
