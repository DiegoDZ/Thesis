...
In this dissertation we have presented an isothemal theory for a fluid in contact with a solid.
The atoms of the solid are frozen in a way that there is no interaction between them. 
...
In this way, and it was something in which we worked the first year of my doctoral thesis, is to derive a non-isothermal theory for a fluid incontact with a solid. The theory is similar to the proposed in Chapter \ref{Chap:Theory} but with more relevant variables that capture both the energy of the fluid and the energy of the solid. The interest behind this, and the motivation, is to understand what happens in a nanoparticle.  
