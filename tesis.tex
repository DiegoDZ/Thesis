...
\caption{Comparison  of   the  error   between  local   and  non-local
  ...
  curve corresponds to  a different node $\mu$.  The top  panel is for
  the   error    with   the   local   prediction    corresponding   to
  Fig. \ref{Fig:LocalPrediction}.  Bottom panel  is for the error with
  the     non-local      prediction     corresponding      to     Fig.
  \ref{Fig.gxevol}. Vertical red  line is at $t=\tau$  where the error
