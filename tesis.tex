...
%We use the corrected Green-Kubo expression in order to avoid the plateu problem. 
%The main result of this publication is the calculation of the slip length and the location of the hydrodynamic position of the atomic wall. We conclude that the slip length does not depend on the size of the channel and, therefore, it is a intrinsic surface property.  
% 
