...
Navier-Stokes equations of hydrodynamics. These equations are based on the conservation of mass, momentum and energy, and are supplemented with
...
while the second  approach is the non-local viscosity  model. 
...
\label{GenNewtonian}   %Figura 2.3. de Evans y Morris. 
\end{align}
...
In Sec. \ref{Sec:Sim} we present the simulation results and we conclude
...
In the second part of this chapter -- Sec.s \ref{Sec:MoriShearHydro} and \ref{Sec:Sim} --  we  have computed from  MD simulations  the equilibrium
