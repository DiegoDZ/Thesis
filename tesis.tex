...
\cite{Donev}  \Note{No encuentro la referencia}  and  consists on  approximating within  ensemble averages
...
\nonumber\\
&-\sum_{\nu=1}^{N_{\rm bin}}{\cal V}_\nu \frac{{\bf e}_3\esc\left[\boldsymbol{\eta}_{\mu\nu}-\boldsymbol{\eta}_{\mu-1\nu}-\boldsymbol{\eta}_{\mu\nu-1}+\boldsymbol{\eta}_{\mu-1\nu-1}\right]}{\Delta z^2}:{\bf e}_3\tilde{\bf v}_\nu
\nonumber\\
&+\sum_{\nu=1}^{N_{\rm bin}}{\cal V}_\nu\frac{\left[{\bf G}_{\mu\nu}-{\bf G}_{\mu\nu-1}\right]}{\Delta z}:{\bf e}_3\tilde{\bf v}_\nu
\nonumber\\
&+\sum_{\nu=1}^{N_{\rm bin}}{\cal V}_\nu\frac{{\bf e}_3\esc\left[{\bf H}_{\mu\nu}-{\bf H}_{\mu-1\nu}\right]}{\Delta z}\esc(\tilde{\bf v}_\nu-{\bf V})
\nonumber\\
...
=&+\sum_{\nu=1}^{N_{\rm bin}}{\cal V}_\nu\frac{\left[{\bf G}^{\pm}_{\mu\nu}-{\bf G}^{\pm}_{\mu\nu-1}\right]}{\Delta z}\esc {\bf e}_3\tilde{\bf v}_\nu
\nonumber\\
&+\sum_{\nu=1}^{N_{\rm bin}}{\cal V}_\nu\frac{{\bf e}_3\esc\left[{\bf H}^{\pm}_{\mu\nu}-{\bf H}^{\pm}_{\mu-1\nu}\right]}{\Delta z}
\esc(\tilde{\bf v}_\nu-{\bf V}^\pm)
\nonumber\\
...
mass density (\ref{CGvar}) we arrive at the final expression for
