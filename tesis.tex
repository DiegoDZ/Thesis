...
Although there is not unanimity in the community about the real impact of this lecture in the development of the nanotechnology \cite{Nature2009}, it is considered its date of birth \cite{Tourney2008}. 
...
Nanothecnology applied to medical devices is a reality. In the last 20 years there has been an rapidly increase in the nanotechnology patents \cite{Zheng2014} and there is a huge interest in the development of new nanomaterials to treat and diagnose cancer \cite{Nazir2014, Dreaden2012, Kievit2011}. 

\Note{Del paper planar} \\
This   advances  in   miniaturization  and   the  development   of  new
experimental techniques  addressing the  nanoscale have  increased the
interest in the  theoretical understanding of the  behaviour of fluids
near                   walls                  at                   the
nanoscale\cite{Lauga2005,KarniadakisBook2005}.          The
...
walls  with  MD \cite{Koplik1995,Wang2017}.   In  particular,  two phenomena  are
...
molecules.   For equilibrium  liquids near  walls, Density  Functional
Theory (DFT) has  been an exceptionally good theoretical  tool for the
prediction of  these layering effects \cite{Hansen1986}.   Second, the
...
\cite{Thompson1990,Koplik1995,Thompson1997}.    Statistical  Mechanics
...
with  an  interesting  debate  that,  in our  opinion,  has  not  been
concluded yet  (see \cite{Ramos-Alvarado2016}  for a recent  review of
the situation).
\\
\Note{Fin paper planar} 


\Note{Del paper Walls}
The unrelenting quest for miniature  devices useful for bio-medical and
other  important   technology  has   witnessed  a  huge   interest  in
theoretical  and simulation  approaches towards  the understanding  of
fluids at  very small scales.   At nanoscopic scales,  a fluid
...
of Thomson and Robins \cite{Thompson1990,Koplik1995,Thompson1997}.
\Note{Fin paper WALLS}



\Note{Del paper theory} \\
...
\Note{Distinguir entre Mori y Kawasaki}\\

\Note{Viene de la introducción del paper de GK corregido}
...
\\
\Note{Fin intro del paper corregido}
