...
\Tirar{The symbol $\hat{A}(z)$ denotes a collection of phase functions each one labeled with a discrete index. 
...
\Pendiente{The principal objetive of the ToCG is to derive the dynamic equations of the CG variables. The two ideas that allow for derivation of dynamic equations are quasi-equilibrium and separation of time scales.}
...
Suppose that $a$ is a discrete variable and $\Phi[\lambda]$ the convex functional plotted in the pannel (1) of the Figure \ref{fig:PhiConvex}. 
