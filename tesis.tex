...
In this chapter we revisit the plateau problem in the Green-Kubo formula. Within the context of Mori projection operator formulation, we offer an alternative expression for the transport coefficients that is given by a corretec Green-Kubo expression that has no plateau problem. 
...
\chapter{Correlations of transverse momentum}\label{Chap:TransMomentum}
