...
in the discrete density variables \Note{Repasar significado de $\rho(r)$, $\rho_\mu$ y $\hat{\rho}_\mu$}
\begin{align}
  \llangle \hat{\rho}_{\bf r}\rrangle^{\lambda{\bf v}}&\simeq\rho_\mu\psi_\mu({\bf r})=\overline{\rho}({\bf r})
\end{align}
\Note{Desarrollo hasta final de sección ok!}
...
\label{overlined}
\end{align}
\Note{Tilde para distinguirlas de las variables conjugadas continuas obtenidas a partir de las discretas}
...
evaluation. \Note{We simply  assume  that we  may
...
\nonumber\\
-&\sum_{\nu=1}^{N_{\rm bin}}{\cal V}_\nu \frac{{\bf e}_3\esc\left[\boldsymbol{\eta}_{\mu\nu}-\boldsymbol{\eta}_{\mu-1\nu}-\boldsymbol{\eta}_{\mu\nu-1}+\boldsymbol{\eta}_{\mu-1\nu-1}\right]}{\Delta z^2}:{\bf e}_3\overline{\bf v}_\nu
\nonumber\\
+&\sum_{\nu=1}^{N_{\rm bin}}{\cal V}_\nu\frac{\left[{\bf G}_{\mu\nu}-{\bf G}_{\mu\nu-1}\right]}{\Delta z}:{\bf e}_3\overline{\bf v}_\nu
\nonumber\\
+&\sum_{\nu=1}^{N_{\rm bin}}{\cal V}_\nu\frac{{\bf e}_3\esc\left[{\bf H}_{\mu\nu}-{\bf H}_{\mu-1\nu}\right]}{\Delta z}\esc(\overline{\bf v}_\nu-{\bf V})
\nonumber\\
...
=&+\sum_{\nu=1}^{N_{\rm bin}}{\cal V}_\nu\frac{\left[{\bf G}^{\pm}_{\mu\nu}-{\bf G}^{\pm}_{\mu\nu-1}\right]}{\Delta z}\esc {\bf e}_3\overline{\bf v}_\nu
\nonumber\\
