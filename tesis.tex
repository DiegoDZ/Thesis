...
The equilibrium theory of SM provides an interpretation for he equilibrium thermodynamics systems from a molecular point of view. 
Nevertheless, most of the phenomena present in the Nature are in nonequilibrium situations. 
Before Green \cite{Green1952, Green1954} formulated in the 50's the Nonequilibrium Statistical Mechanics (NESM) in the way we know nowadays, Einstein \cite{Einstein1905}, Onsager \cite{Onsager1931} and Kirkwood \cite{Kirkwood1946} made important contributions. It was in the decade of the 60's when Zwanzig \cite{Zwanzig1961} and Mori \cite{Mori1965} reformulated the theory using the technique of the projection operators \cite{Grabert1982}. 
