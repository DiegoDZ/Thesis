...
\textsc{This chapter corresponds to the article \textit{Discrete hydrodynamics I: Theory for planar flows with confining walls} published in \textit{Physical Review E}. DOI:77777/77777}

\vspace{20pt}
In this chapter we follow the same route established in the derivation of the hydrodynamic equations presented in the Chapter \ref{Chap:Theory}. We start from a set of discrete CG variables to derive the corresponding discrete equations of motion.  
