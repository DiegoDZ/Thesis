...
\textsc{\Huge{Nanoscale hydrodynamics \\near solids}}
      ...
      \tikz[remember picture,overlay] \node[opacity=0.08,inner sep=0pt] at (0,3) {\includegraphics[width=0.6\paperwidth,height=0.6\paperwidth]{escudoUNED}};
      %\tikz[remember picture,overlay] \node[opacity=0.08,inner sep=0pt] at (current page.center){\includegraphics[width=0.6\paperwidth,height=0.6\paperwidth]{escudoUNED}};
...
%\includegraphics[scale=0.6]{logoED}
\end{flushright}
\vspace*{\fill}
