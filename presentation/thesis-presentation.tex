...
\end{frame}
 ...
 \begin{frame}{Simulation set up}
   \begin{itemize}
     \item LAMMPS code.
     \item Box size $40x40x30$ binned in $60$ bins along $z$ axis.
     \item LJ potential truncated at $\sigma=2.5$.
     \item Timestep $0.002$ in reduced units. 
     \item $T=2.0$, $\rho=0.6$ and $N=28749$ particles.
     \end{itemize}
\Note{Un dibujo del proceso de equilibrado y producción quedaría bien}
 \end{frame}
