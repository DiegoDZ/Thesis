...
\begin{figure}[h!]
\includegraphics[width=0.48\linewidth]{Density-WALLS-defense}
\end{figure}
    \begin{itemize}
...
\begin{frame}{El sistema y las variables relevantes}
  \begin{itemize}
    ...
    \item<3-> Variables relevantes
      ...
      \nonumber
      \end{align}
    \item<4-> Derivadas de las variables relevantes
      \begin{align}
  ...
  %\begin{itemize}
    ...
    La teoría presentada no puede ser validada a través de simulaciones:
      \begin{enumerate}
        ...
        \item Demasiada información en las ecs. hidrodinámicas: kernels de transporte no locales y de caracter tensorial. 
      \end{enumerate}
...
\end{frame}
  ...
  \begin{frame}{Condición de contorno en teoría local}
    \begin{itemize}
      \item[] \alert{Teoría local} \textbf{sin sólidos} con condiciones de contorno:
        \begin{align}
      \overline{\bf v}^x_{\rm wall}(t) = \delta(t)\dot{\overline{\gamma}}_{\rm wall}(t)
        \nonumber
        \end{align}
...
\begin{frame}{Conclusiones}
  \begin{enumerate}
    ...
    \item<2-> Ecuaciones hidrodinámica fluido en contacto con paredes planas. 
