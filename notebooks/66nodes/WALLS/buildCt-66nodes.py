...
if gxgx=='y':
    ...
    np.savetxt('Ct-WALLS-66nodes.dat'          , Ct)
    ...
    np.savetxt('Ct-WALLS-66nodes-500steps.dat' , Ct[0:500,:])
...
#---------------Build matrices of correlations---------------
    ...
    np.savetxt('SxzSxz-WALLS-66nodes.dat'         , C)
    ...
    np.savetxt('SxzFx-WALLS-66nodes.dat', C1)
    np.savetxt('FxSxz-WALLS-66nodes.dat', C2)
    np.savetxt('FxFx-WALLS-66nodes.dat' , C3)
